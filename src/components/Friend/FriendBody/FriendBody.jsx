...
const FriendBody = ({ currentPrivateChannel, user, privateMessages, handleCurrentPrivateChannel, friendList, handleAddPrivateMessage, }) => {
    ...
    return (
        <Box className="friend-main-container">
            ...
            {
                currentPrivateChannel.uid ?
                    <PrivateChat currentPrivateChannel={currentPrivateChannel} user={user} userSideBar={userSideBar} privateMessages={privateMessages} handleAddPrivateMessage={handleAddPrivateMessage} />
                    :
                    category === "addfriend" ?
