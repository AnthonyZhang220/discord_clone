...
import { toggleVoice, toggleHeadphone } from "../../../redux/features/controlSlice";
    ...
    return (
        <Box component="footer" className="user-footer-container" ref={userAvatarRef}>
            <Box onClick={() => dispatch(setUserDetailPopover(true))} className="user-footer-profile" >
                ...
                >
                    <Avatar alt={user.name} sx={{ width: "30px", height: "30px" }} src={user.profileURL} className="avatar" />
                </Badge>
            ...
            <UserDetailPopover user={user} userAvatarRef={userAvatarRef} />
